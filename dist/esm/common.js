 ...
 * ```
 */
export function getHerokuConfigOptions(apiKey, apiUrl, apiEndpoint) {
 ...
 * ```
 */
export function getHerokuConfigOptionsWithEnvKeys(apiKey, apiUrl, apiEndpoint, envKeyName = "INFERENCE_KEY", envUrlName = "INFERENCE_URL") {
    ...
    const resolvedApiUrlBase = apiUrl ?? process.env[envUrlName] ?? DEFAULT_INFERENCE_URL;
 ...
 * ```
 */
export function langchainMessagesToHerokuMessages(messages) {
 ...
 * ```
 */
export function langchainToolsToHerokuTools(tools) {
 ...
 */
export async function* parseHerokuSSE(stream, onDone, onError) {
