...
exports.HerokuMiaEmbeddings = void 0;
 ...
 */
class HerokuMiaEmbeddings extends embeddings_1.Embeddings {
    ...
    async makeRequest(requestPayload) {
        const herokuConfig = (0, common_1.getHerokuConfigOptionsWithEnvKeys)(this.apiKey, this.apiUrl, "/v1/embeddings", "EMBEDDING_KEY", "EMBEDDING_URL");
        let response;
        let attempt = 0;
        ...
        while (attempt <= maxRetries) {
            try {
                ...
                if (!response.ok) {
                    ...
                    const error = new common_1.HerokuApiError(`${errorMessage}\nDetails: ${detailedMessage}`, response.status, errorData);
                    throw error;
                }
                ...
                const isRetryable = error instanceof common_1.HerokuApiError &&
                    error.status &&
...
exports.HerokuMiaEmbeddings = HerokuMiaEmbeddings;
